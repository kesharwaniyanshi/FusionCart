...
# Fetch the records from 81 to 130
new_records_df = df.iloc[106:206]

# Apply the fetch_image_url function to the "Product Name" and "Brand Name" columns for new records
new_records_df["Image URL"] = new_records_df.apply(lambda row: fetch_image_url(row["Product Name"], row["Brand"]), axis=1)
...
print("Image URLs for records 81 to 130 have been added and saved to updated_supermarket_dataset_limited.csv")
